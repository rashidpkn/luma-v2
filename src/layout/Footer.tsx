        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-12 border-b border-white/10">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <a
              ...
              className="w-10 h-10 rounded-full bg-[#071324] hover:bg-main-green/20 text-white hover:text-main-green flex items-center justify-center transition-colors"
            >
                ...
                {col.links.map((link) => (
                  <li key={link.label}>
                    <a
                      ...
                      className="text-gray-400 hover:text-main-green text-base transition-colors"
                    >
                      {link.label}
                    </a>
                  </li>
