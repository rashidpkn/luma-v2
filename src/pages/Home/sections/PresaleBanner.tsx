      ...
      <div className="relative max-w-5xl mx-auto px-4 text-center z-10">
        ...
        <div className="flex items-center justify-center mt-10">
          <a
            ...
            rel="noreferrer"
            href="#early-access"
            className="btn-glow-shadow leftglow border border-main-blue px-8 md:px-10 py-4 text-lg md:text-xl text-center tracking-tighter text-white font-bold bg-main-blue rounded-full cursor-pointer transition-transform active:scale-95"
          >
