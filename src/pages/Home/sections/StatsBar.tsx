      ...
      <div className="max-w-7xl px-4 2xl:mx-auto w-full grid grid-cols-2 xl:grid-cols-5 items-center justify-center gap-6 md:gap-y-10 2xl:gap-x-6">
        ...
        <div className="flex justify-center items-center md:flex-row flex-col gap-3 md:items-start text-center md:text-left">
          <div className="text-green-500 shrink-0">
            <svg width="44" height="44" viewBox="0 0 48 48" fill="none" className="text-main-green-700">
              <circle cx="24" cy="24" r="22" stroke="#00B15B" strokeWidth="2.5" />
              <path d="M12 24h24M24 12c-4 4-6 8-6 12s2 8 6 12M24 12c4 4 6 8 6 12s-2 8-6 12" stroke="#00B15B" strokeWidth="2.5" />
            </svg>
          </div>
          <div>
        ...
        <div className="flex justify-center items-center md:flex-row flex-col gap-3 md:items-start text-center md:text-left">
          <div className="text-green-500 shrink-0">
            <svg width="44" height="44" viewBox="0 0 24 24" fill="#00B15B">
        ...
        <div className="flex justify-center items-center md:flex-row flex-col gap-3 md:items-start text-center md:text-left">
          <div className="text-green-500 shrink-0">
            <svg width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="#00B15B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
