    ...
    <section className="bg-blue-soft px-4 py-16 md:px-6 md:py-24">
      <div className="mx-auto max-w-6xl">
        {whyChooseItems.map((item, index) => (
          <article key={item.id} className="grid items-center gap-6 border-t border-[#c5dff0] py-10 md:grid-cols-12 md:gap-10 md:py-12">
            ...
            <div className="md:col-span-5">
              <div className="flex justify-center rounded-[1.5rem] bg-white px-4 py-6">
                <img alt={item.title} src={item.image} width={850} height={950} className="max-h-[260px] w-auto max-w-full object-contain" />
              </div>
            </div>
          </article>
        ))}
        <div className="flex flex-wrap gap-3 border-t border-[#c5dff0] pt-10">
