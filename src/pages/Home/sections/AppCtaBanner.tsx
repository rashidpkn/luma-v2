          ...
          <div className="max-w-xl lg:max-w-2xl text-left">
            ...
            <div className="mt-8">
              <a
                ...
                rel="noreferrer"
                href="#get-started"
                className="btn-glow-shadow leftglow border border-main-blue inline-flex items-center px-8 py-3.5 text-base sm:text-lg text-center tracking-tighter text-white font-bold bg-main-blue rounded-full cursor-pointer transition-transform active:scale-95"
              >
                Download the App
              </a>
            </div>
