  ...
  return (
    <section id="services" className="bg-white px-4 py-16 md:px-6 md:py-24">
      <div className="mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <div className="flex justify-center rounded-[1.75rem] bg-blue-soft p-6">
      ...
      <div className="mx-auto mt-12 grid max-w-6xl gap-4 md:grid-cols-6">
        {featureCards.map((card, index) => (
          <article key={card.title} className={`flex flex-col overflow-hidden rounded-[1.5rem] bg-blue-soft ${spans[index] ?? ""}`}>
            <div className="flex h-44 items-center justify-center bg-white/70">
